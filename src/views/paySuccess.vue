  ...
  <div id="main">
  	<div class="content page-order-payment">
  	   ...
  	   <!--     <div class="box-inner payment-checkout-panel clear">
                ...
                <span v-else class='is-pay'>支付已完成~</span>
  	            <span class="prices"> 应付金额：   <em><span>¥ </span>{{orderInfo.price}}.00</em>   </span>
  	        </div> -->
  	    </div>
		<span @click="back" class="jianguo-blue-main-btn big-main-btn js-payment-order">
		    <a>返回</a>
		</span>
...
export default{
  ...
  methods:{
	  updateOrderStatus(){//支付成功，请求后台接口
		  y.get('/payment/notify',this.$route.query,data=>{
